...
databasedir ='/gpfs/group/jle7/default/kmn18/graduateresearch/MSG_2008/archive.eumetsat.int/umarf/onlinedownload/KellyNunez/1354496/';

%databasedir ='/gpfs/group/jle7/default/kmn18/graduateresearch/MSG_2007/August_September_2007/';
%databasedir='/gpfs/group/jle7/default/kmn18/graduateresearch/MSG_2007/August_October_2007/archive.eumetsat.int/umarf/onlinedownload/KellyNunez/1270360/1/'; % Aug_Oct 2007
...
%outputbasedir ='/gpfs/group/jle7/default/kmn18/graduateresearch/outputfiles/2006MSGdailyfileslargedomain/'; % location of outputfiles 
%outputbasedir ='/gpfs/group/jle7/default/kmn18/graduateresearch/outputfiles/'; % location of outputfiles 
outputbasedir ='/gpfs/group/jle7/default/kmn18/graduateresearch/outputfiles/2008MSGdailyfileslargedomain_2/';
% Which files to search for in folders
myfiles=dir([databasedir, '*EUMG_YMD*.nc' ]);  
%myfiles=dir([databasedir, '*EUMG_20070501*.nc' ]);  
kiddy=1;
previous_day = 0;
...
%clear all variables after saving
